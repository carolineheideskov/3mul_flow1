...
if(filter_input(INPUT_GET, 'update')) {
    ...
    foreach ($_SESSION['cart'] as $val){
			...
			echo '<br /> Produkt: '  . $name  . '<br> Antal: ' . '<input name="quantity' . $id . '" type="text" value="' . $val['quantity'] . '"/>';
...
<a href="cart.php?new_order=yes"><button name="submit" id="indsend" value="indsend">Køb</button></a>
<a href="index.php"><button>Tilbage til produkter</button></a>
<br>
<br>
</div>
</body>
